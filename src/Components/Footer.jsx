...
.footer-logo { font-size: 26px; font-weight: 700; margin-bottom: 10px; }
.footer-about { font-size: 14px; color: #bbb; margin-bottom: 25px; }
...
.footer-center { display: flex; justify-content: space-between; gap: 40px; }
.footer-center h3 { font-size: 18px; margin-bottom: 15px; }
.footer-center ul { list-style: none; padding: 0; }
.footer-center ul li { margin-bottom: 8px; }
...
.footer-right h3 { font-size: 18px; margin-bottom: 15px; }
.footer-right p { font-size: 14px; color: #bbb; margin-bottom: 10px; }
...
@media (max-width: 900px) { .footer-center { flex-direction: column; } }
